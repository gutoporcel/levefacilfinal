        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li class="active"><a href="listaSolicitacoesCliente.jsp"><i
                                class="icon-briefcase"></i>Solicitações</a></li>
                    <li><a href="listaLeilaoCliente.jsp"><i class="icon-legal"></i>Leilão Reverso</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-toolbar">
                        <div class="btn-toolbar">
                            <div class="btn-group">
                                <a href="gerenciarPagamentoCliente.jsp" class="btn"><i class="icol-accept"></i> Aceitar</a>
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form">
                                ...
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-8-8">
                                        ...
                                        <div class="mws-form-item">
                                            <input type="text" value="Unicsul - AF, Anália Franco, São Paulo - SP">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-8-8">
                                        ...
                                        <div class="mws-form-item">
                                            <input type="text" value="Unicsul - Liberdade, Liberdade, São Paulo - SP">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    ...
                                    <div class="mws-form-col-3-8">
                                        ...
                                        <div class="mws-form-item">
                                            <input type="date" value="25/04/2019">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-4-8">
                                        ...
                                        <div class="mws-form-item">
                                            <label class="mws-form-label"><strong>Aguardando Orçamento</strong></label>
                                        </div>
                                    </div>
                                    <div class="mws-form-col-4-8">
                            ...
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-8-8">
                                        <label class="mws-form-label">Imagens</label>
                                        <div class="mws-form-item">
                                            <input type="file">
                                        </div>
                                    </div>
