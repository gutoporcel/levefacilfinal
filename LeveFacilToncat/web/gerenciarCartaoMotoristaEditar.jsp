        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li class="active"><a href="listaCartoesMotorista.jsp"><i class="icon-business-card"></i>Cartões</a></li>
                    <li><a href="listaCarrosMotorista.jsp"><i class="icon-truck"></i>Veículos</a></li>
                    <li><a href="listaSolicitacoesMotorista.jsp"><i class="icon-briefcase"></i>Solicitações</a></li>
