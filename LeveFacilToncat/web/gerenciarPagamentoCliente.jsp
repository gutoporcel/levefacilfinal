        ...
        function pagamento()
            {
                ...
                document.formPagamento.acao.value = 'pagar';
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                ...
                <li><a href="listaTransacoesCliente.jsp"><i class="icon-briefcase"></i>Histórico</a></li>
                   ...
                   <li class="active"><a href="gerenciarPagamentoCliente.jsp"><i class="icon-lock"></i>Pagamentos</a></li>
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                        ...
                        <table id="exemplo" class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                              ...
                                              <%
                                                  ...
                                                  //ped.setIdCliente(id);
                                        ArrayList<MFinalizaOrcamento> lista5 = new OrcamentoDao().listarorcamentoClienteAguardandoPagamento(user);
                   ...
                   <div class="mws-panel-body no-padding">
                       <form class="mws-form" action="Orcamento" name="formPagamento" method="post">
                             ...
                             %>
                             <option value="<%= lista.get(i).getNumeroCartao()%>" > <%= lista.get(i).getNumeroCartao() %></option>
                                              <% } %>
                                            </select>
                                         ...
                                         <button class="btn" type="button" onclick="pagamento()" value="confirma" />Efetuar pagamento</button>
