...
<script>
          ...
          function funcao2()
        {
          if(validaSituacaoMoto()){
        document.form_ativa_destaivaMoto.acao.value = 'confirmaM';
               document.form_ativa_destaivaMoto.submit();
          }
        }
       function  validaSituacaoMoto(){
              var ID = form_ativa_destaivaMoto.id.value;
              //var CPF = form_ativa_destaivaMoto.cpf.value;

                                        if (ID === "") {
                                            alert('Preencha o campo com id  do Cliente');
                                           form_ativa_destaivaMoto.id.focus();
                                            return false;
                                        }
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> Lista de Usuarios (Motorista)</span>
                    </div>
                    
                              <form name="form_ativa_destaivaMoto" action="GerenciaUsuarioCliente" method="post">
                        ...
                        <div class="mws-panel-body"  >
                          ...
                          <input type="text" id="id" name="ID" class=""  />
                           ...
                           <button class="btn" type="button" onclick="funcao2()" value="confirmaM" />Confirmar</button>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                                                     <%
            ArrayList<MMotorista> lista = new MotoristaDAO().listarMotorista();
            for(int i=0; i<lista.size(); i++) {
                out.println("<tr>");
           
                out.println("<td>" + lista.get(i).getIdMotorista()+ "</td>");
                out.println("<td>" + lista.get(i).getNome()+ "</td>");
                out.println("<td>" + lista.get(i).getCpf()+ "</td>");
                out.println("<td>" + lista.get(i).getEmail()+ "</td>");
                out.println("<td>" + lista.get(i).getSituacao()+ "</td>");
