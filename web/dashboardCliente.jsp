                  ...
                  <br>
                      ...
                      <div class="clearfix"></div></div> 
                        ...
                        <form class="mws-form" method="post" action="PrincipalCliente" name="frmPedido" id="pedido">
                                ...
                                <div class="mws-form-cols">
                                    ...
                                    <div class="mws-form-col-8-8">
                                        ...
                                        <div class="mws-form-item">
                                            <input type="text"id="route_from" name="partida" placeholder="Digite o endere�o com o  numero, CPF  ou nome do lugar   ">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-8-8">
                                        ...
                                        <div class="mws-form-item">
                                            <input name="destino" type="text" id="route_des" onchange="CalculaDistancia()" placeholder="Digite o endere�o com o  numero, CPF  ou nome do lugar   " >
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <!-- <button class="btn" id="calcuarDistancia "type="submit" value="Tra�ar rota"  onclick="CalculaDistancia()" />Tra�ar rota</button>
                            -->
                            ...
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label">Dist�ncia:</label>
                                        <div class="mws-form-item">
                            ...
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-8-8">
                                        <label class="mws-form-label">Descri��o da Carga:</label>
                                        <div class="mws-form-item">
                                            <textarea name="descricao" class="big"  type="text"  placeholder="Digite as caracteristicas do produto. Ex: nome, peso, dimens�es"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
