                                    ...
                                    MMotorista  motorista = new MMotorista();
                                      ...
                                      ArrayList<MMotorista> lista = new MotoristaDAO().listarMotoristaDados(motorista);
                                        for (int i = 0; i < lista.size(); i++) {                                          
                                            ...
                                            out.println("<b>RG: </b>" + lista.get(i).getNumero_rg()+ "<br>");//
                                            out.println("<b>CPF: </b> " + lista.get(i).getCpf()+ "<br>");//
                                            out.println("<b>Data nascimento: </b>" + lista.get(i).getData_nac()+ "<br>");  //
                                            out.println("<b>Telefone: </b>" + lista.get(i).getTelefone()+ "<br>");//
                                            out.println("<b>Celular: </b>" + lista.get(i).getCelular()+ "<br>");//
                                            out.println("<b>E-mail: </b>" + lista.get(i).getEmail()+ "<br>");//
                                            out.println("<b>CNH </b>" + lista.get(i).getNumero_cnh()+ "<br>"); //
                                            out.println("<b>Vencimento Cnh </b>" + lista.get(i).getValidade_cnh()+ "<br>"); //
                                            out.println("<b>Categoria: </b>" + lista.get(i).getCategoria_cnh()+ "<br>");// 
                                            out.println("<b>CEP: </b>" + lista.get(i).getCep()+ "<br>");//
                                            out.println("<b>Rua: </b>" + lista.get(i).getLogradouro()+ "<br>");//
                                            out.println("<b>N°: </b>" + lista.get(i).getNumero()+ "<br>");//
                                            out.println("<b>Complemento: </b>" + lista.get(i).getComplemento()+ "<br>");//
                                            out.println("<b>Bairro: </b>" + lista.get(i).getBairro()+ "<br>");
                                            out.println("<b>Cidade: </b>" + lista.get(i).getCidade()+ "<br>");
                                            out.println("<b>Estado: </b>" + lista.get(i).getEstado()+ "<br>");
                                            out.println("<b>Situação: </b>" + lista.get(i).getSituacao()+ "<br>");        
                                            out.println("<b>Senha: </b>" + lista.get(i).getSenha()+ "<br>");
        ...
        %>
                        ...
                        <hr>
                    	    <div class="mws-button-row">
                                <a href="dadosMotoristaEditar.jsp">  <button  type="submit" value="Editar " class="btn btn-danger">Editar</button></a>
