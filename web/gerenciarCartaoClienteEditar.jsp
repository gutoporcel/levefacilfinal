        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li><a href="gerenciarSolicitacaoCliente.jsp"><i class="icon-briefcase"></i> Nova Solicitação</a></li>
                    ...
                    <li><a href="listaSolicitacoesCliente.jsp"><i class="icon-briefcase"></i>Histórico</a></li>
                </ul>
            </div>         
        </div>
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form">
							...
							<div id="debito" style="display:none;" class="formulario">
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    ...
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label">Operação</label>
                                        <div class="mws-form-item">
                            ...
                            <div id="credito" style="display:none;" class="formulario">
                            <div class="mws-form-row">
                                <div class="mws-form-cols">
                                    <div class="mws-form-col-3-8">
                                        <label class="mws-form-label">Cartão</label>
                                        <div class="mws-form-item">
