                ...
                <div class="container">
                    ...
                    <div class="mws-panel grid_8">
                        ...
                        <div class="mws-panel-body no-padding">
                            <form class="mws-form" name="formAlteraCartao" action="Cartao" method="post">
                                <div class="">
                                       ...
                                       <div class="mws-form-row"> 
                                            ...
                                            <select name="idCartao" id="idCartao">
                             ...
                             %>
                             <option value="<%= lista.get(i).getId_cartao()%>" > <%= lista.get(i).getNumeroCartao() %></option>
                                              <% } %>
                                            </select>
