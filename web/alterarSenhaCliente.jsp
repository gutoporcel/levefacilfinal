...
<head>
        ...
        <script>
            ...
            {
                if(validaForm()){
                    document.formAlteraSenhaClinete.acao.value = 'alteraSenha';
                    document.formAlteraSenhaClinete.submit();
                }
                    
                
            }
          function  validaForm() {
                var senha = formAlteraSenhaClinete.senha.value;
                var novaSenha = formAlteraSenhaClinete.novaSenha.value;
                var confirmaSenha = formAlteraSenhaClinete.confirmaNovaSenha.value;

                if (senha === "") {
                    alert('Preencha sua senha ');
                    formAlteraSenhaClinete.senha.focus();
                    return false;
                }
                if (novaSenha === "") {
                    alert('Preencha o campo nova senha');
                    formAlteraSenhaClinete.novaSenha.focus();
                    return false;
                }
                  if (confirmaSenha === "") {
                    alert('Preencha o campo  caonfirma nova senha');
                    formAlteraSenhaClinete.confirmaNovaSenha.focus();
                    return false;
                }
...
<body>
    ...
    <div id="mws-wrapper">
            ...
            <div id="mws-navigation">
                <ul>
                 ...
                 <li><a href="listaTransacoesCliente.jsp"><i class="icon-briefcase"></i>Histórico</a></li>
                      ...
                      <li><a href="gerenciarPagamentoCliente.jsp"><i class="icon-lock"></i>Pagamento</a></li>
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" name="formAlteraSenhaClinete" action="AlteraCliente" method="post">
            ...
            <!-- Footer -->
            <div id="mws-footer">
            	Sistema Desenvolvido por José Augusto Porcel Stacio grupo 3 - Leve Facil &copy; 2019,
            </div>
