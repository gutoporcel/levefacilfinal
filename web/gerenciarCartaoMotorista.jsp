...
<script>
 ...
 function  validaCadastroContaMotosita() {
                ...
                var titular =formInserirConta.titular.value;
                var banco = formInserirConta.banco.value;
                var tipoConta =  formInserirConta.tipoConta.value;
                var agencia =  formInserirConta.agencia.value;
                var conta = formInserirConta.conta.value;
                
                
                
                if (titular === "") {
                    alert('Preencha o campo com  nome do Titular  da conta');
                  formInserirConta.titular.focus();
                    return false;
                }
          
                   if ( banco === "") {
                    alert('Prencha o campo com nome do Banco ');
                    formInserirConta.banco.focus();
                    return false;
                }
            
                     if ( tipoConta === "") {
                    alert('Selecione o tipo de conta');
                    formInserirConta.tipoConta.focus();
                    return false;
                }
                       if ( agencia === "") {
                    alert('Preencha o campo agencia');
                    formInserirConta.agencia.focus();
                    return false;
                }
                       if ( conta === "") {
                    alert('Preencha o campo conta');
                    formInserirConta.conta.focus();
                    return false;
                }
                return true;
